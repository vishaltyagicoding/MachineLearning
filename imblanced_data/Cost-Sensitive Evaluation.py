...
catogorical_cols = X_train.select_dtypes(include=['object']).columns
...
best_model = XGBClassifier(**best_trial.params, random_state=42,scale_pos_weight=(y_train == 0).sum() / (y_train == 1).sum(),)

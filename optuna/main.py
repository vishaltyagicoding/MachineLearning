...
# optuna to optimize hyperparameters for XGBoost
def objective(trial):
    param = {
    ...
    n_negative = (y == 0).sum()  # Assuming 0 is majority class
    n_positive = (y == 1).sum()  # Assuming 1 is minority class
...
param = {'n_estimators': 295, 'max_depth': 4, 'learning_rate': 0.20270650392357586, 'subsample': 0.8080959412579622, 'colsample_bytree': 0.9070309405132595, 'scale_pos_weight': 4.811327620519576}
